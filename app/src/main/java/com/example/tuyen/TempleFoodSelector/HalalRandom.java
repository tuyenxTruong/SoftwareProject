...
public class HalalRandom extends AppCompatActivity {
    final String[] places = {
            "Halal Kebab King", "Philly Fellas Gyro Halal", "Sunny Halal Food", "Ebi's Lunch Truck (Halal)", "Famous NY Gyro (Halal", "Halal Gyro Express",
    };
    Button maps;
    Button randomize;
    TextView place;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent showMap = new Intent(HalalRandom.this, HalalMaps.class);
                showMap.putExtra(HalalMaps.EXTRA_SELECTED_RESTAURANT,
                        randomRestaurant);
