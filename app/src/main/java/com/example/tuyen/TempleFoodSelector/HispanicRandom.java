...
public class HispanicRandom extends AppCompatActivity {
    final String[] places = {
            "El Guaco Loco", "Mexican Grill Stand",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent showMap = new Intent(HispanicRandom.this, HispanicMaps.class);
                showMap.putExtra(HispanicMaps.EXTRA_SELECTED_RESTAURANT,
                        randomRestaurant);
